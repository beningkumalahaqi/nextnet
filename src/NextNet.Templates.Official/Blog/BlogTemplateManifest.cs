    ...
    public static TemplateManifest Create()
    {
        var manifest = new TemplateManifest(
            ...
            Files: new List<TemplateFile>
            {
                ...
                new(SourcePath: "app/blog/page.cs", TargetPath: "{{projectName}}.App/blog/page.cs"),
                new(SourcePath: "app/blog/[slug]/page.cs", TargetPath: "{{projectName}}.App/blog/[slug]/page.cs"),
