...
namespace NextNet.SourceGenerators.Tests.GeneratorTests
{
    ...
    public class WrapperEmitterTests
    {
        ...
        [Fact]
        public void Emit_ShouldContainPageWrappers_WhenSampleManifest()
        {
        ...
        [Fact]
        public void Emit_ShouldContainLayoutWrappers_WhenSampleManifest()
        {
            var manifest = CreateSampleManifest();
            var result = WrapperEmitter.Emit(manifest, "app", TestNs);
        ...
        [Fact]
        public void Emit_ShouldContainApiRouteWrapper_WhenSampleManifest()
        {
            var manifest = CreateSampleManifest();
            var result = WrapperEmitter.Emit(manifest, "app", TestNs);
        ...
        [Fact]
        public void Emit_ShouldContainErrorPageWrapper_WhenSampleManifest()
        {
            var manifest = CreateSampleManifest();
            var result = WrapperEmitter.Emit(manifest, "app", TestNs);
        ...
        [Fact]
        public void Emit_ShouldImplementIPage_WhenPageWrapper()
        {
            var manifest = CreateSampleManifest();
            var result = WrapperEmitter.Emit(manifest, "app", TestNs);
        ...
        [Fact]
        public void Emit_ShouldImplementILayout_WhenLayoutWrapper()
        {
            var manifest = CreateSampleManifest();
            var result = WrapperEmitter.Emit(manifest, "app", TestNs);
        ...
        [Fact]
        public void Emit_ShouldHaveRenderMethod_WhenPageWrapper()
        {
            var manifest = CreateSampleManifest();
            var result = WrapperEmitter.Emit(manifest, "app", TestNs);
        ...
        [Fact]
        public void Emit_ShouldImplementIErrorPage_WhenErrorPageWrapper()
        {
            var manifest = CreateSampleManifest();
            var result = WrapperEmitter.Emit(manifest, "app", TestNs);
        ...
        [Fact]
        public void Emit_ShouldAssignRouteParams_WhenDynamicPageWrapper()
        {
            var manifest = CreateSampleManifest();
            var result = WrapperEmitter.Emit(manifest, "app", TestNs);
        ...
        [Fact]
        public void Emit_ShouldReturnNoWrappers_WhenManifestEmpty()
        {
