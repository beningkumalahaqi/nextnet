...
{
    [Fact]
    public void WriteLog_WritesMessage()
    {
    ...
    [Fact]
    public void WriteSuccess_WritesMessage()
    {
    ...
    [Fact]
    public void WriteWarning_WritesMessage()
    {
    ...
    [Fact]
    public void WriteInfo_WritesMessage()
    {
    ...
    [Fact]
    public void WriteHeading_WritesMessage()
    {
    ...
    [Fact]
    public void WriteMuted_WritesMessage()
    {
